...
namespace DotNetCoreInventoryDashboard.Datasets {
    ...
    public partial class dsCustomer : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string Name, string Email, string Phone, string Address, string Country, string City) {
...
namespace DotNetCoreInventoryDashboard.Datasets.dsCustomerTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Customers] SET [Name] = @Name, [Email] = @Email, [Phone] = @Phone, [Address] = @Address, [City] = @City, [Country] = @Country WHERE (([CustomerId] = @Original_CustomerId));
SELECT Name, Email, Phone, Address, City, Country, CustomerId FROM Customers WHERE (CustomerId = @CustomerId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Name, Email, Phone, Address, City,Country, CustomerId FROM Customers";
        ...
        public virtual int Fill(dsCustomer.CustomersDataTable dataTable) {
        ...
        public virtual dsCustomer.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
