...
const ProductPurchaseDetailReport = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const response = await fetch(
      `${url}/api/purchaseDetail/purchase_details_product/${sdateISO}/${edateISO}/${productName}`,
      {
        method: "GET",
    ...
    if (res) {
      window.open(`${url}/api/purchaseDetail/purchase_details_product/${sdateISO}/${edateISO}/${productName}`);
    } else {
...
export default ProductPurchaseDetailReport;
