        ...
        <>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-10 gap-4 items-center">
              ...
              <span className="col-span-1 font-semibold">Department Name</span>
              <div className="col-span-4 py-1 md:py-2 lg:py-2">
                <select
                  className={
              ...
              <span className="col-span-1 font-semibold">Employee Name</span>
              <div className="col-span-4">
                <input
                  type="text"
                  autoComplete="name"
                  className={errors.employeeName?.type=="required"?"px-2 py-2  outline-none border border-rose-400 w-full":"px-2 py-2  outline-none border w-full"}
